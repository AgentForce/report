    ...
    constructor() {
        ...
        this.getRecruitmentInWeek = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (countuser.length === 0) {
                ...
                if (isNaN(count_user.currentsurvey))
                    count_user.currentsurvey = 0;
                if (isNaN(count_user.targetsurvey))
                    count_user.targetsurvey = 0;
                if (isNaN(count_user.currentcop))
                    count_user.currentcop = 0;
                if (isNaN(count_user.targetcop))
                    count_user.targetcop = 0;
                if (isNaN(count_user.currentmit))
                    count_user.currentmit = 0;
                if (isNaN(count_user.targetmit))
                    count_user.targetmit = 0;
                if (isNaN(count_user.currentagentcode))
                    count_user.currentagentcode = 0;
                if (isNaN(count_user.targetagentcode))
